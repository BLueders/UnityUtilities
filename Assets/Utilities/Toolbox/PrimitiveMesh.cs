...
{
    /// <summary>
    /// Provides several code generated mesh primitives
    /// </summary>
    public class PrimitiveMesh : MonoBehaviour
    {
        ...
        static Mesh _PlaneMeshXZ;

        public static Mesh PlaneMeshXZ
        {
            get
            {
                if (_PlaneMeshXZ == null)
                {
                    Mesh mesh = new Mesh();
                    mesh.Clear();
        ...
        static Mesh _PlaneMeshXY;

        public static Mesh PlaneMeshXY
        {
            get
            {
                if (_PlaneMeshXY == null)
                {
                    Mesh mesh = new Mesh();
                    mesh.Clear();
